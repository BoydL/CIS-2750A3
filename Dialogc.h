 ...
 * Class:     Dialogc
 * Method:    PM_parse
 * Signature: (JLjava/lang/String;C)I
 */
JNIEXPORT jint JNICALL Java_Dialogc_PM_1parse
 ...
 * Signature: (I)J
 */
JNIEXPORT jlong JNICALL Java_Dialogc_PM_1create
  (JNIEnv *, jobject, jint);
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_Dialogc_PM_1destroy
 ...
 */
JNIEXPORT jint JNICALL Java_Dialogc_PM_1manage
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_Dialogc_PM_1getList
 ...
 * Signature: (JLjava/lang/String;)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_Dialogc_PM_1getString
  (JNIEnv *, jobject, jlong, jstring);
